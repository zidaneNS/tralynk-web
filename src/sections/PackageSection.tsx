...
export default function PackageSection() {
  return (
    <div id="packages" className="flex flex-col items-center px-12 py-12 gap-y-12 scroll-mt-16 w-full">
      <div className="flex flex-col items-center gap-y-6">
        <h1 className="text-6xl font-semibold">Popular <span className="text-blue-500">packages</span></h1>
        <p className="text-center max-w-2/3">Handpicked travel experiences designed to give you the best of every destination—at the best value.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 w-full gap-8">
        {packages.map((pkg, idx) => (
          <div key={idx} className="flex flex-col shadow-md w-full rounded-md">
            <img src={pkg.imgSrc} alt="img" className="w-full h-1/3 object-cover object-center rounded-t-md" />
            <div className="flex flex-col p-6 gap-y-6 h-fit">
              ...
              <div className="flex gap-x-6 items-center">
                ...
                <p className="text-slate-500">Starting a - <br /> person</p>
              </div>
              <div className="flex flex-col md:flex-row gap-6 items-center">
                <button className="bg-blue-500 text-white py-2 px-6 rounded-full cursor-pointer hover:bg-blue-400 duration-300 text-sm w-full md:w-fit flex-1">Get enquiry</button>
